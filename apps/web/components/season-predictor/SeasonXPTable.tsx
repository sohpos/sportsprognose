...
const formatXP = (value: any): string =>
  (typeof value === "number" ? value : 0).toFixed(2);

// FIX: championProb & relegationProb are 0–1 → convert to %
...
export function SeasonXPTable({ data, teams }: SeasonXPTableProps) {
  ...
  return (
    <div
      className="rounded-xl bg-white dark:bg-neutral-900 shadow-lg overflow-hidden"
      data-testid="xp-table"
    >
